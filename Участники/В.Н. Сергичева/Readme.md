...
|----------------|----------------|
|Встречи с командой | 21|
|Заполнение Битрикс24 | 6|
|Регистрицая в клубе разработчиков nanoCAD | 2|
|Установка nanoCAD | 2|
|Изучение API nanoCAD | 25|
|Написание поста | 1|
|Коммуникации с командой | 11|
|Конференция разработчиков | 9|
|Создание видеоурока | 3|
|Создание канала (RuTube) | 1|
|Монтирование видео для канала | 5|
|Проверка отчетов команды | 2|
|Написание отчетов ||
